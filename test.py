...
parser.add_argument("--data_dir", type=str, default="D:/PycharmProjects/FUnIE-GAN-master/data/test/A")
parser.add_argument("--sample_dir", type=str, default="D:/PycharmProjects/FUnIE-GAN-master/data/output")
parser.add_argument("--model_name", type=str, default="ugan") # or "ugan"
parser.add_argument("--model_path", type=str, default="D:/PycharmProjects/FUnIE-GAN-master/PyTorch/models/funie_generator.pth")
